...
class SelectPDFAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (mAction == Action.MERGE_PDF) {
            if (BackList.instance!!.list[position].click == true) {
                itemViewHolder.imageViewTick.setBackgroundResource(R.drawable.bg_tick)
            } else {
                itemViewHolder.imageViewTick.setBackgroundResource(R.drawable.bgr_tick)
            }
        } else {
    ...
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var imageViewTick: ImageView = itemView.findViewById(R.id.item_ok)
