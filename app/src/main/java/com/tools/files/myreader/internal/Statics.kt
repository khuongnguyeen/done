package com.tools.files.myreader.internal
...
import com.tools.files.myreader.ulti.ImageUtils
...
object Statics {
    ...
    fun createPdf(app: Application, name: String):String {
        ...
        sb.append("/Documents/PDF/PDFtools")
    ...
    private fun clearData(app: Application) {
    ...
    fun isAvailable(name: String): Boolean {
        ...
        for (file in files) {
            if (file.toLowerCase() == name.toLowerCase() + ".pdf") {
                return false
            }
        }
        return true
